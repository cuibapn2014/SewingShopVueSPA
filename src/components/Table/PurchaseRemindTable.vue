          ...
          <span
            :class="{
              ...
              'px-2 py-1 font-semibold leading-tight rounded-full dark:text-white bg-orange-100 text-orange-700 dark:bg-orange-600':
                item.status == 1,
              'px-2 py-1 font-semibold leading-tight rounded-full dark:text-white bg-indigo-100 text-indigo-700 dark:bg-indigo-600':
                item.status == 2,
