<template>
  <aside class="
    ...
    <div class="py-4 text-gray-500 dark:text-gray-400">
      ...
      <ul class="mt-6">
          ...
          <button class="
            ...
            <span class="inline-flex items-center">
              ...
              <span class="ml-4" :class="{
                'text-gray-800': this.isSaleActive,
                'dark:text-gray-100': this.isSaleActive,
            ...
            <template v-if="isSalesMenuOpen">
              <ul class="
                ...
                <li class="cursor-pointer 
                          ...
                          dark:hover:text-gray-200
                        ">
                  <router-link to="/order" class="w-full hover:text-gray-800 dark:hover:text-gray-200" :class="{
                ...
                <li class="cursor-pointer 
                          ...
                          dark:hover:text-gray-200
                        ">
                  <router-link to="/customer" class="w-full hover:text-gray-800 dark:hover:text-gray-200" :class="{
        ...
        <li class="cursor-pointer relative px-6 py-3">
          <span v-if="this.isProductionActive" class="
                    absolute
                    inset-y-0
                    left-0
                    w-1
          ...
          <button class="
            ...
            <span class="inline-flex items-center">
              ...
              <span class="ml-4" :class="{
                'text-gray-800': this.isProductionActive,
                'dark:text-gray-100': this.isProductionActive,
            ...
            <template v-if="isProductionMenuOpen">
              <ul class="
                ...
                <li class="cursor-pointer 
                          ...
                          dark:hover:text-gray-200
                        ">
                  <router-link to="/production-suggest" class="w-full hover:text-gray-800 dark:hover:text-gray-200"
                    :class="{
                      'text-gray-800': isRoute('production-suggest'),
                      'dark:text-gray-100': isRoute('production-suggest'),
                    }">
                    Đề nghị sản xuất
                  </router-link>
                </li>
                <li class="cursor-pointer 
                          ...
                          dark:hover:text-gray-200
                        ">
                  <router-link to="/productions" class="w-full hover:text-gray-800 dark:hover:text-gray-200" :class="{
                    'text-gray-800': isRoute('productions'),
                    'dark:text-gray-100': isRoute('productions'),
                  }">
                    Lệnh sản xuất
                  </router-link>
                </li>
                <li class="cursor-pointer 
                          ...
                          dark:hover:text-gray-200
                        ">
                  <router-link to="/purchase-remind" class="w-full hover:text-gray-800 dark:hover:text-gray-200" :class="{
                    'text-gray-800': isRoute('purchase-remind'),
                    'dark:text-gray-100': isRoute('purchase-remind'),
                  }">
                    Đề xuất mua hàng
                  </router-link>
                </li>
        ...
        <li class="cursor-pointer relative px-6 py-3">
          <span v-if="this.isWarehouseActive" class="
                    absolute
                    inset-y-0
                    left-0
                    w-1
          ...
          <button class="
            ...
            <span class="inline-flex items-center">
              ...
              <span class="ml-4" :class="{
                'text-gray-800': this.isWarehouseActive,
                'dark:text-gray-100': this.isWarehouseActive,
              }">
                Kho</span>
            </span>
            ...
            <template v-if="isWarehouseMenuOpen">
              <ul class="
                ...
                <li class="cursor-pointer 
                          ...
                          dark:hover:text-gray-200
                        ">
                  <router-link to="/warehouse-export" class="w-full hover:text-gray-800 dark:hover:text-gray-200" :class="{
    ...
    <h2 class="w-full h-auto text-sm px-3 dark:text-gray-200">
      {{ new Date().getFullYear() }} © All right Reserved
    </h2>
    <h2 class="w-full h-auto text-sm px-3 dark:text-gray-200">
      Developed by Manh Tuan
    </h2>
  </aside>
  <!-- Mobile sidebar -->
  <!-- Backdrop -->
  <transition enter-from-class="opacity-0" enter-to-class="opacity-100" leave-from-class="opacity-100"
    ...
    <div v-show="isSideMenuOpen" class="
              fixed
              inset-0
              flex
              duration-150
        ...
        <ul class="mt-6">
          <li class="cursor-pointer relative px-6 py-3">
            <span v-if="isRoute('dashboard')" class="
                      ...
                      rounded-tr-lg rounded-br-lg
                    " aria-hidden="true"></span>
            <router-link @click="closeSideMenu()" to="/dashboard" class="
                      inline-flex
                      items-center
                      w-full
                      text-sm
        ...
        <ul>
              ...
              <template v-if="isSalesMenuOpen">
                <ul class="
                  ...
                  <li class="cursor-pointer 
                            ...
                            dark:hover:text-gray-200
                          ">
                    <router-link @click="closeSideMenu()" to="/order" class="
                              w-full
                              hover:text-gray-800
                              dark:hover:text-gray-200
                            " :class="{
                  ...
                  <li class="cursor-pointer 
                            ...
                            dark:hover:text-gray-200
                          ">
                    <router-link @click="closeSideMenu()" to="/customer" class="
                              w-full
                              hover:text-gray-800
                              dark:hover:text-gray-200
                            " :class="{
              ...
              <template v-if="isProductionMenuOpen">
                <ul class="
                  ...
                  <li class="cursor-pointer 
                            ...
                            dark:hover:text-gray-200
                          ">
                    <router-link @click="closeSideMenu()" to="/production-suggest" class="
                              w-full
                              hover:text-gray-800
                              dark:hover:text-gray-200
                            " :class="{
                  ...
                  <li class="cursor-pointer 
                            ...
                            dark:hover:text-gray-200
                          ">
                    <router-link @click="closeSideMenu()" to="/productions" class="
                              w-full
                              hover:text-gray-800
                              dark:hover:text-gray-200
                            " :class="{
                  ...
                  <li class="cursor-pointer 
                            ...
                            dark:hover:text-gray-200
                          ">
                    <router-link @click="closeSideMenu()" to="/purchase-remind" class="
                              w-full
                              hover:text-gray-800
                              dark:hover:text-gray-200
                            " :class="{
              ...
              <template v-if="isWarehouseMenuOpen">
                <ul class="
                  ...
                  <li class="cursor-pointer 
                            ...
                            dark:hover:text-gray-200
                          ">
                    <router-link @click="closeSideMenu()" to="/warehouse-import" class="
                              w-full
                              hover:text-gray-800
                              dark:hover:text-gray-200
                            " :class="{
                  ...
                  <li class="cursor-pointer 
                            ...
                            dark:hover:text-gray-200
                          ">
                    <router-link @click="closeSideMenu()" to="warehouse-export" class="
                              w-full
                              hover:text-gray-800
                              dark:hover:text-gray-200
                            " :class="{
                  ...
                  <li class="cursor-pointer 
                            ...
                            dark:hover:text-gray-200
                          ">
                    <router-link @click="closeSideMenu()" to="/ingredient" class="
                              w-full
                              hover:text-gray-800
                              dark:hover:text-gray-200
                            " :class="{
                  ...
                  <li class="cursor-pointer 
                            ...
                            dark:hover:text-gray-200
                          ">
                    <router-link @click="closeSideMenu()" to="/product" class="
                              w-full
                              hover:text-gray-800
                              dark:hover:text-gray-200
                            " :class="{
          ...
          <li class="cursor-pointer relative px-6 py-3">
            <span v-if="isRoute('task')" class="
                      ...
                      rounded-tr-lg rounded-br-lg
                    " aria-hidden="true"></span>
            <router-link @click="closeSideMenu()" to="/task" class="
                      inline-flex
                      items-center
                      w-full
                      text-sm
          ...
          <li class="cursor-pointer relative px-6 py-3">
            <span v-if="isRoute('provider')" class="
                      ...
                      rounded-tr-lg rounded-br-lg
                    " aria-hidden="true"></span>
            <router-link @click="closeSideMenu()" to="/provider" class="
                      inline-flex
                      items-center
                      w-full
                      text-sm
          ...
          <li class="cursor-pointer relative px-6 py-3">
            <span v-if="isRoute('finance')" class="
                      ...
                      rounded-tr-lg rounded-br-lg
                    " aria-hidden="true"></span>
            <router-link @click="closeSideMenu()" to="/finance" class="
                      inline-flex
                      items-center
                      w-full
                      text-sm
...
export default {
  ...
  computed: {
    ...
    isProductionActive() {
      const arr = ['production-suggest', 'productions', 'purchase-remind'];
