<template>
    ...
    <div class="flex justify-center flex-1 lg:mr-32">
      <div class="relative w-full max-w-xl mr-6 focus-within:text-purple-500">
        ...
        <input
          ...
          type="text"
          placeholder="Nhấp phím [/] để bắt đầu tìm kiếm"
          ref="search_input"
          aria-label="Search"
        />
      </div>
      ...
      <li class="relative">
        ...
        >
          <img
            ...
            :src="this.base_url + '/img/user/' + this.user?.image"
            alt=""
            aria-hidden="true"
            loading="lazy"
          />
        ...
        >
          <template v-if="isProfileMenuOpen">
            ...
            >
              <li class="flex">
                <a
                  class="inline-flex items-center cursor-pointer w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200"
                  @click="openModal"
                >
                  <svg
                    class="w-4 h-4 mr-3"
  ...
  <ProfileModal :display="this.isShowModal" @close="closeModal" />
  <SettingModal :display="this.isShowSettingModal" @close="closeSettingModal" />
</template>
<script>
