  ...
  <div class="w-full relative" ref="select_custom">
    <label class="block text-sm mt-2 relative">
      ...
      <input
        ...
        autocomplete="off"
      />
      <svg v-if="isAllowClear" @click="this.clear()" xmlns="http://www.w3.org/2000/svg" class="cursor-pointer h-4 w-4 absolute right-3 top-8 text-gray-800 dark:text-gray-200" viewBox="0 0 20 20" fill="currentColor">
