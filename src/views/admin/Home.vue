      ...
      <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
        ...
        ">
          <div class="
            ...
            bg-red-100
            rounded-full
            dark:text-red-100 dark:bg-red-500
          ">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd"
                d="M4 4a2 2 0 00-2 2v4a2 2 0 002 2V6h10a2 2 0 00-2-2H4zm2 6a2 2 0 012-2h8a2 2 0 012 2v4a2 2 0 01-2 2H8a2 2 0 01-2-2v-4zm6 4a2 2 0 100-4 2 2 0 000 4z"
        ...
        ">
          <div class="
            ...
            bg-indigo-100
            rounded-full
            dark:text-indigo-100 dark:bg-indigo-500
          ">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              <path
                d="M3 1a1 1 0 000 2h1.22l.305 1.222a.997.997 0 00.01.042l1.358 5.43-.893.892C3.74 11.846 4.632 14 6.414 14H15a1 1 0 000-2H6.414l1-1H14a1 1 0 00.894-.553l3-6A1 1 0 0017 3H6.28l-.31-1.243A1 1 0 005 1H3zM16 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM6.5 18a1.5 1.5 0 100-3 1.5 1.5 0 000 3z">
      ...
      <div class="grid gap-6 mb-8 md:grid-cols-2">
        <div class="min-w-0 p-4 bg-[#ffffff] rounded-lg shadow-xs dark:bg-gray-800">
          <h4 class="mb-4 font-semibold text-gray-800 dark:text-gray-300">
            Thống kê các đơn hàng trong năm {{ new Date().getFullYear() }}
          </h4>
        ...
        <div class="min-w-0 p-4 bg-[#ffffff] rounded-lg shadow-xs dark:bg-gray-800">
          <h4 class="mb-4 font-semibold text-gray-800 dark:text-gray-300">
            Doanh thu trong năm {{ new Date().getFullYear() }}
          </h4>
        ...
        <div class="min-w-0 p-4 bg-[#ffffff] rounded-lg shadow-xs dark:bg-gray-800">
          <h4 class="mb-4 font-semibold text-gray-800 dark:text-gray-300">
            Thống kê đơn hàng trong năm {{ new Date().getFullYear() }}
          </h4>
